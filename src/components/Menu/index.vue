...
const menuItems = ref([
  ...
  {
    bgColorItem: '#ffb8c6', viewBox: '0 0 24 24', paths: [
...
function offsetMenuBorder(index: number) {
  ...
  if (menuBorderRef.value !== null) {
    console.log()
    menuBorderRef.value.style.left = (left || 0) - (menuBorderRef.value.clientWidth / 8) + 'px';
  }
}
...
.menu {
  ...
  z-index: 999;
  box-shadow: 0px 0px 37px rgba(0, 0, 0, 0.51);
